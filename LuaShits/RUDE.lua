function onCreatePost() 
    ...
    addLuaText("typeText")
        ...
        makeLuaText("songText", "Unrude", 500, 30, 30)
...
doTweenX('backgrounds/gibran2', 'backgrounds/gibran2.scale', 0 - 50*math.sin((currentBeat+1*0.1)*math.pi), 6)
doTweenY('backgrounds/gibran2', 'backgrounds/gibran2.scale', 0 - 31*math.sin((currentBeat+1*1)*math.pi), 6)
